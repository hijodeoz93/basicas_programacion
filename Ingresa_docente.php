...
if(!$insert =$con->query("INSERT INTO docente (Nombre_d, Sexo_D, Telefono_D, Correo_D, Dependencia,Cargo) values ('$val2[0]','$val2[1]',$val2[2],'$val2[3]','$val2[4]','$val2[5]')") or die ($con->error)){
