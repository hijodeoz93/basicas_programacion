...
$id=mysqli_fetch_array($Id_us) or die($con->error)or die ($con->error);
print_r($_POST);
...
if(!$insert =$con->query("INSERT INTO docente (Nombre_d, Sexo_D, Telefono_D, Correo_D, Dependencia,Cargo) values ('".strtoupper($val2[0])."','".strtoupper($val2[1])."',$val2[2],'".strtoupper($val2[3])."','".strtoupper($val2[4])."','".strtoupper($val2[5])."')") or die ($con->error)){
